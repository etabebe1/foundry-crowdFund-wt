...
# ds for deploy-sepolia 
ds:
	forge script script/DeployCrowdFund.s.sol:DeployCrowdFund --rpc-url $(SEPOLIA_RPC_URL) --private-key $(PRIVATE_KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
